...
import com.cxp.gank.ui.adapter.holder.BaseViewHolder
import com.cxp.gank.ui.adapter.holder.LoadingHolder

/**
 * 文 件 名: BaseAdapter
 * 创 建 人: CXP
 * 创建日期: 2019-07-19 11:00
 * 描    述:
 * 修 改 人:
 * 修改时间：
 * 修改备注：
...
abstract class BaseAdapter<T>(
    ...
    private fun footerSize(): Int {
        if (loadingStatus == LoadingHolder.STATUS_HIDDEN) return 0
    ...
    private fun shouldLoadMore(recyclerView: RecyclerView, shouldLoadMore: Boolean, dx: Int = 0, dy: Int = 0) {
        //如果loadMoreListener不等于null 返回loadMoreListener 否则return
